...
export default function Home() {
  ...
  return (
    ...
    <Link href="/" className='float-right mr-2 pt-2 font-bold'>See Users</Link>
      ...
      {users.map((user) => (
        <div key={user.id} data-testid="post" className='w-46 p-2 m-4 border-1 border-gray-300 shadow-xl  rounded-2xl bg-white cursor-pointer hover:transform hover:scale-105 transition-all duration-300'>
